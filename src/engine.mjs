export const APP_VERSION = "phase3-v1.6";
...
export function buildHumanResolutionOptions(profileInput = {}) {
...
export function executeScenario(scenarioId) {
...
export function runWorkflow(profileInput, state = createInitialState()) {
  const profile = createProfile(profileInput);
  prepareFreshRun(state, profile);
  return processWorkflow(profile, state);
}

export function continueWorkflow(profileInput, state) {
...
export function runAdaptation(state, feedbackInput = {}) {
...
export function acceptPlan(state) {
...
export function requestRevision(state) {
  if (!state.currentPlan || !state.awaitingUserDecision) {
...
export function renderablePlanSections(state) {
