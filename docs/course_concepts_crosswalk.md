...
| L6 role-based cooperation | The system uses Intake, Constraint & Risk Checker, Plan Composer, Review & Adaptation Agent, and Human-in-the-Loop roles. | `docs/phase3_architecture_workflow.png`; `outputs/sample_runs/P3-01_baseline.json` |
